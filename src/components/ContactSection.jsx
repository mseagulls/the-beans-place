...
function ContactFormInline() {
    // All four fields in one object. These must match the "name" props on the Inpute below - thats what makes handleChange work.
    ...
    // "blue" fired on leaving a field - mark is as visited
    const handleBlur = (e) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            // PLACEHOLDER: send nothing, just fakes 1.2s of network
        ...
        >
            <div className="mb-6">
                ...
                <p className="contact-form-subtitle">
                    We'd love to hear back from you. Fill out the form and we'll get back within 24 hours.
                </p>
            </div>
            ...
            <div className="contact-form-grid">
                ...
                <Input 
                    ...
                    id="contact-email"
                    name="email"
                    // type="email" also gets phones to shoe the @ key
                    type="email"
            ...
            <div className="mt-6 flex items-center gap-4">
                <Button
                    ...
                    // Greyed out mid-send so nobody douchle submits
...
export default function ContactSection() {
    // Pointer position is the window, for the flow that follows the cursor
            ...
            <div className="contact-inner">
                ...
                <ScrollReveal animation="fadeUp" className="contact-header">
                    ...
                    <p className="lead--light" style={{ maxWidth: "52ch", margin: "10px auto 0" }}>
                        Whether you're ordering beans, planning an event, or just want to say hello - we'd love to hear from you
                    </p>
                                ...
                                <StaggerItem key={channel.name} animation="fadeUp">
                                    ...
                                    >
                                        <div className="contact-card">
                                            {/* Edge bar - innline style because the color comes from the data */}
                                            <div 
