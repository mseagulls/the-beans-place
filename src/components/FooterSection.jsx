...
function LocationMap() {
    // mapRef -> the <div> the map draes into
    ...
    useEffect( () => {
        // Stop if the map already exists or if the target div isn't ready
    ...
    return(
        <footer className="footer">
            <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:pt-32 2xl:max-w-400">
                {/* Map (wrapped in ScrollReveal so it fades up into ciew on scroll) */}
                <scrollReveal animation="fadeUp">
                    <locationMap />
                </scrollReveal>
                
                {/* Footer columns (2 colimns on small screens, 4 on medium+) */}
                <div className="mt-16 grid grid-cols-2 gap-8 md:grid-cols-4">
                    ...
                    <ScrollReveal animation="fadeUp" className="col-span-2 md:col-span-1 space-y-4">
                        ...
                        <p className="footer-description justify-self-center text-center md:justify-self-auto md:text-left">
                            Premium coffe beans, roasted to order and shipped fresh. From our roastery to your cup since 2012
                        </p>
