    ...
    return(
        ...
        <div id="home" className="hero-text-column">
            ...
            <motion.div
                ...
                {/* Shop Coffee button. oneclick finds the element with the ID="shop" and smoothly scrolls to it. The ?. (optional chaining) avoids an error if that element doesn't exist */}
                <Button
                    variant="accent"
                    size="lg"
                    className="shadow-lg"
        ...
        <div className="hero-art-container">
             ...
             <motion.img
                ...
                {/* Floating price badge that pops onto the image.
                    ...
                    delay: 1.2 waits until the image has arrives */}
                <motion.div
                    ...
                    <span classNamw="hero-floating-badge-label">FROM</span>
